...
def train(depth_min):
    ...
    df_noise = pd.read_csv("/media/viktor/T7/gravitational-waves-kaggle-2022/datasets/realistic_noise_256/realistic_noise_256.csv")
    ...
    def load_data(file_path, test_data=False):
        ...
        random_H1 = np.array(Image.open(f"/media/viktor/T7/gravitational-waves-kaggle-2022/datasets/realistic_noise_256/{random_folder}/H1.png"))
        random_L1 = np.array(Image.open(f"/media/viktor/T7/gravitational-waves-kaggle-2022/datasets/realistic_noise_256/{random_folder}/L1.png"))
    ...
    model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=5.E-04),
